...
- (void)viewDidLoad {
    ...
    [self.labelButton updateButtonLabelLabelWithButtonImage:[UIImage imageNamed:@"test_Little_image"] buttonFontSize:15 buttonTitle:nil buttonTitleColor:nil topTitle:@"里程dfg dsfg ad fdsafesdf" topLabelFontSize:16 topTextColor:[UIColor blackColor] bottomTitle:@"15km" bottomLabelFontSize:13 bottomTextColor:[UIColor redColor] spacingHeight:3.0f];
    
    /// 上面一个button  下面一个label
    self.labelButton2 = [[LabelButtonView alloc]initWithFrame:CGRectMake(self.labelButton.left, self.labelButton.bottom + 30, 100, 50)];
